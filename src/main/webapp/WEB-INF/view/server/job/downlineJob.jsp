            ...
            <li class="job-item odd">
                <ul class="job-details">
                    ...
                    <li class="details3">
                        ...
                        <div class="operate">
                            <a class="opeate-item" href="javascript:;"><span class="icon-refresh"></span>重上线</a>
...
<script type="text/javascript" data-main="/static/js/server/job/downLine" src="/static/js/lib/r.js"></script>
</body>
</html>